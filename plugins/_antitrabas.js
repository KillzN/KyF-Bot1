/**
𝐊 𝐲 𝐅 - 𝐁𝐎𝐓 @kattia.dzn - _antitrabas.js
...
export async function before(m, { conn, isAdmin, isBotAdmin, usedPrefix }) {
  ...
  const fakemek = { 'key': { 'participant': '0@s.whatsapp.net', 'remoteJid': '0@s.whatsapp.net' }, 'message': { 'groupInviteMessage': { 'groupJid': '56932786316-1616969743@g.us', 'inviteCode': 'm', 'groupName': 'P', 'caption': '𝐊 𝐲 𝐅 - 𝐁𝐎𝐓', 'jpegThumbnail': null } } };
